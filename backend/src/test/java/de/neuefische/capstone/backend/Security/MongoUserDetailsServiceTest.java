...
import de.neuefische.capstone.backend.security.MongoUserWithNoId;
...
class MongoUserDetailsServiceTest {
    ...
    void returnUser_WhenUsernameExists() {
        // Given
        MongoUser mongoUser = new MongoUser("1", "test", "test");
    ...
    void verifyRepoCalls_WhenUserIsRegistered() {
        //Given
        MongoUserWithNoId mongoUserWithNoId = new MongoUserWithNoId("test", "test");
        when(mongoUserRepository.findByUsername("test"))
                .thenReturn(Optional.empty());
